...
const Header = ({ totalCartItems, totalCompareItems, toggleClick, totalWishlistItems, headerStyle = "", isToggled = false }) => {
                                        ...
                                        <div className="cart-dropdown-wrap cart-dropdown-hm2">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <div className="shopping-cart-title">
                                                        <h4>
                                                            <Link href="/shop-grid-right">Macbook Pro 2026</Link>
                                                        </h4>
                                                        <h3>
                                                            <span>1 × </span>
                                                            $3500.00
