                                        ...
                                        <div className="single-page pr-30 mb-lg-0 mb-sm-5">
                                            <div className="single-header style-2">
                                                ...
                                                <div className="entry-meta meta-1 meta-3 font-xs mt-15 mb-15">
                                                    ...
                                                    <span className="post-on has-dot">9 April 2026</span>
                                            ...
                                            <div className="single-content mb-50">
                                                ...
                                                <ol start={1}>
                                                    <li>
                                                        Hi there, we’re AliThemes Pty Ltd (ABN 11 119 159 741) of Level 1, 121 King Street Melbourne, 3000, Australia (“<strong>AliThemes</strong>”) and welcome to our privacy policy which also applies to our Affiliate Companies. This policy sets out how we handle your personal information if you’re an AliThemes user or visitor to our Sites. It applies across AliThemes Elements, AliThemes Market, AliThemes Twenty20, AliThemes Studio, AliThemes Sites, AliThemes Tuts+ and Placeit (the “<strong>Sites</strong>”).
                                                    </li>
                                                ...
                                                <ol start={17}>
                                                    <li>
                                                        For more information about how we use cookies, web beacons and similar technologies see our cookie policy <a href="https://AliThemes.com/cookies/">here</a> and for more general information on cookies, see{" "}
                                                    ...
                                                    <li>
                                                        Occasionally, we will use third party advertising companies to serve ads based on prior visits to our Sites. For example, if you visit our Sites, you may later see an add for our products and services when you visit a different Site. Read more about your options in our <a href="https://AliThemes.com/cookies/">cookie policy</a>.
                                                    </li>
                                                </ol>
                                                ...
                                                <ol start={22}>
                                                    <li>
                                                        ...
                                                        and take other actions permitted by law. The information we retain will be handled in accordance with this Privacy Policy.
                                                    </li>
                                                </ol>
                                                ...
                                                <ol start={25}>
                                                    <li>
                                                        If you have any questions about our privacy practices or the way in which we have been managing your personal information, please contact our privacy champion in writing at PO Box 16122 Collins Street West Victoria 8007 Australia or <a href="mailto:privacy.champion@AliThemes.com">privacy.champion@AliThemes.com</a>.
                                                    </li>
                                                ...
                                                <ol start={1}>
                                                    <li>
                                                        For the purposes of applicable EU data protection law (including the General Data Protection Regulation 2016/679 (the “<strong>GDPR</strong>
                                                        ”), we are a ‘data controller’ of your personal information.
                                                    </li>
                                                </ol>
                                                <h4>How you can access your personal information</h4>
                                                <ol start={2}>
